    ...
    return (
        <div>
            <div className="max-w-[1440px] mx-auto md:px-[34px] px-4 min-h-[100vh] mt-11 pb-[75px] relative flex flex-col items-start lg:justify-end">
                ...
                {/*===================== card ==================*/}
                <div className="relative bottom-[38%] mx-auto mt-7 w-full max-w-[450px] rounded-[38px] border-2 border-gray-200 p-1 md:mt-14 md:max-w-[550px] lg:absolute lg:mt-0 lg:w-[38vw] lg:max-w-[705px] xl:w-[45vw] right-[0%] flex text-black">
                    <div className="min-w-32 h-auto border-neutral-200 p-6 md:p-5 lg:w-[40vw] lg:min-w-[42%] lg:!max-w-[286px] lg:border-b-0 lg:p-6 lg:border-r-2">
                        <span><svg xmlns="http://www.w3.org/2000/svg" width="34" height="34" fill="currentColor" class="bi bi-person-circle" viewBox="0 0 16 16">
